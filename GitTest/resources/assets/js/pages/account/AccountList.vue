  ...
  <div class="container">
    <header>
      <div class="title-wrap">
        <h2 style="width:20%;">アカウント一覧</h2>
        <tr style="width:80%;float: right">
          <td class="button-s" @click.prevent="searchAccounts(searchWord)" style="float: right;margin-right: 10px;">
            検索
          </td>
          <td class="header-friend-serch">
            <input type="text" v-model="searchWord" placeholder="アカウント名、メールアドレス検索">
          </td>
          ...
          <td class="button-s" @click.prevent="fetchAccounts()" style="float: right;margin-right: 20px;">
            検索クリア
          </td>
        </tr>
      </div>
