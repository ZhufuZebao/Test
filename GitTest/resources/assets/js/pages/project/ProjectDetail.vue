  ...
  <div class="commonAll container clearfix projectdetail">
    ...
    <section class="common-wrapper">
      <div class="common-wrapper-container">
        ...
        <div class="content" v-if="projectBasisDetail">
          <h3>案件基本情報</h3>
          <table class="detail-table">
            <!--<a class="edit" @click="projectBasisShow" v-if="editDetail">-->
            ...
            <!--<tr>-->
              <!--<td class="tdLeft">工事件名</td>-->
              <!--<td class="tdRight">{{project.construction_name}}</td>-->
            <!--</tr>-->
            <tr>
        ...
        <div class="content" v-if="projectCompanyDetail">
          <h3>管理会社・不動産屋 情報</h3>
          <table class="detail-table">
            <!--<a class="edit" @click="projectCompanyShow" v-if="editDetail">-->
              <!--<img src="images/edit@2x.png"/>-->
            <!--</a>-->
            <!--管理会社-->
            <tr>
        ...
        <div class="content" v-if="projectSafetyDetail">
          <h3>安全管理情報</h3>
          <table class="detail-table">
            <!--<a class="edit" @click="projectSafetyShow" v-if="editDetail">-->
              <!--<img src="images/edit@2x.png"/>-->
            <!--</a>-->
            <tr>
        ...
        <div class="content">
           <table class="detail-table">
             <br>
             <tr v-if="projectUser">
               <td class="tdLeft">登録情報</td>
               <td class="tdRight">{{projectUser.project_created_by_lastname}}&nbsp;&nbsp;{{projectUser.project_created_by_firstname}}
                 &nbsp;&nbsp;{{projectUser.project_created_at_date}}({{projectUser.project_created_at_week}})
                 {{projectUser.project_created_at_time}}</td>
             </tr>
             <tr v-if="projectUser.project_updated_by_lastname">
               <td class="tdLeft">更新情報</td>
               <td class="tdRight">{{projectUser.project_updated_by_lastname}}&nbsp;&nbsp;{{projectUser.project_updated_by_firstname}}
                 &nbsp;&nbsp;{{projectUser.project_updated_at_date}}({{projectUser.project_updated_at_week}})
                 {{projectUser.project_updated_at_time}}</td>
             </tr>
           </table>
        </div>
