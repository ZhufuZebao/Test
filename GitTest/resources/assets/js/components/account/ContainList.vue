<template>
    <transition name="fade">
        <div class="modal wd1 modal-show project-enterprise containlist">
            <div class="modalBodyCustomer" ref="modalBody" v-bind:style="{'margin-left': modalLeft,'margin-top': modalTop}">
                ...
                <div class="modalBodycontent">
                    <h3 class="commontitle">データ容量状況</h3>
...
<script>
    ...
    export default {
        ...
        methods: {
            closeModel: function (){
                this.$emit('closeContainliste');
            } ,
            fetch: function () {
                const loading = this.$loading({lock: true, background: 'rgba(0, 0, 0, 0.7)'});
                let errMessage = this.commonMessage.error.system;
                axios.post('/api/enterpriseContain',{
                }).then((res) => {
