        ...
        <div class="content">
          ...
          <el-form :model="user.enterprise" :rules="enterprise" ref="form" label-width="200px"
            ...
            <div class="form-group form-name">
              <el-form-item label="アカウント" prop="last_name"  class="form-last-name" style="margin-bottom: 30px;">
...
<script>
  ...
  export default {
    ...
    mixins: [validation, Messages, reportValidation],
    data: function () {
      return {
        zipFlag:0,
        imageUrl: '',
    ...
    mounted() {
      this.isMounted = true;
      this.zipTmp = {'address1':this.user.enterprise.pref,'address2':this.user.enterprise.town,'address3':this.user.enterprise.street,prefcode: '1',zipcode: this.user.enterprise.zip};
    },
    created() {
      this.fetch();
    },
