    ...
    <dl>
        ...
        <dd>
            ...
            <select name="satisfaction" id="satisfaction">
                <option value=""></option>
                <option value="1"{{ ($evaluations->satisfaction == 1) ? ' selected' : '' }}>★</option>
                <option value="2"{{ ($evaluations->satisfaction == 2) ? ' selected' : '' }}>★★</option>
                <option value="3"{{ ($evaluations->satisfaction == 3) ? ' selected' : '' }}>★★★</option>
                <option value="4"{{ ($evaluations->satisfaction == 4) ? ' selected' : '' }}>★★★★</option>
                <option value="5"{{ ($evaluations->satisfaction == 5) ? ' selected' : '' }}>★★★★★</option>
            </select>
        ...
        <dt>本文</dt>
        <dd>
            <textarea name="comment">{{ old('comment', $evaluations->comment) }}</textarea>
